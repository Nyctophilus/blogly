...
export default function Home() {
  const sectionStyles = `grid place-items-center min-h-[100dvh] before:absolute before:inset-0 before:bg-[#0006] before:backdrop-lg before:z-[-1] after:absolute after:inset-0 after:bg-center	after:bg-no-repeat after:bg-cover after:z-[-2] after:bg-[url(https://images.pexels.com/photos/206359/pexels-photo-206359.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)]`;
